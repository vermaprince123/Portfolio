...
export const courses = [
  {
    ...
    status: "Completed",
    description: "Comprehensive course on Spring Boot covering REST APIs, database integration, and backend architecture",
    year: "2024",
    image: "/achievements/courses/spring-boot.jpg",
  },
  {
    id: 2,
